"""Quality-flag emit paths: sidecar JSON and audit JSONL.

Flags are findings, not emails — every send goes through notify.py, and a
failing emit path never sinks the other.
"""
