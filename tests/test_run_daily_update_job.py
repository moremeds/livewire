...
class TestDailyLanesDoNotTakeTheLegacyLakeLock:
    @pytest.fixture(autouse=True)
    ...
    def test_a_scheduled_lane_starts_while_the_legacy_lock_is_held(self, tmp_path):
    ...
    def test_a_retrying_lane_starts_while_the_legacy_lock_is_held(self, tmp_path):
        from clients.parquet_io import path_lock
        from livewire_scripts.paths import lake_lock_path
