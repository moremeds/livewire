...
def _parser() -> argparse.ArgumentParser:
    ...
    for name in ("preflight", "stage", "transaction", "postcondition"):
...
def main(argv: list[str] | None = None) -> int:
    ...
    elif args.command == "postcondition":
        result = repair.postcondition(args.manifest)
